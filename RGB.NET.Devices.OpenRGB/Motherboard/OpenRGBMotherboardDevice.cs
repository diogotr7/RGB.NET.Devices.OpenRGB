...
{
    public class OpenRGBMotherboardDevice : OpenRGBRGBDevice<OpenRGBDeviceInfo>
    {
        public OpenRGBMotherboardDevice(OpenRGBDeviceInfo info) : base(info) { }

        protected override void InitializeLayout()
        {
            LedId initial = LedId.Mainboard1;
            int y = 0;
